# gatsby-remark-autolink-headers-improved

> forked from [gatsby-remark-auto-headers](ttps://github.com/zidoshare/gatsby-remark-auto-headers)

This fork particularly fixes generating invalid IDs that would crash the whole app.
...
`npm install gatsby-remark-auto-headers-improved`
...
// bad
{
  ...
  options: {
    plugins: [
      `gatsby-remark-prismjs`, // should be placed after `gatsby-remark-auto-headers-improved
      `gatsby-remark-auto-headers-improved`,
    ],
  },
}
...
- <del>`offsetY`: Signed integer. Vertical offset value in pixels</del> (this plugin is able to automatically connect headers and be able to calculate top correctly)
...
- `attr`: String. Set the id to any property
  ...
  plugins: [
    {
      ...
      options: {
        plugins: [
          {
            resolve: `gatsby-remark-auto-headers-improved`,
            options: {
              offsetY: `100`,
