...
> it's forked from [gatsby-remark-autolink-headers](https://github.com/gatsbyjs/gatsby/edit/master/packages/gatsby-remark-autolink-headers)
...
`npm install --save gatsby-remark-auto-headers`
